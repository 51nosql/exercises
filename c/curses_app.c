...
#define MAX_STRING 80	/* Longest allowed respone */
...
const char *title_file = "curses_app.title.cdb";
const char *tracks_file = "curses_app.tracks.cdb";
const char *temp_file = "curses_app.cdb.tmp";
